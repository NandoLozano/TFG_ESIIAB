...
Las empresas que operan en el sector público deben participar en procesos de \bft{licitación} publicados por diversos organismos (Ayuntamientos, Ministerios, entes públicos, etc.). El canal principal para este fin es la \textit{Plataforma de Contratación del Sector Público}, donde los organismos publican sus proyectos. Estos son procesados posteriormente como un \bft{expediente} administrativo que requiere un seguimiento riguroso.
\subsubsection{Expedientes}
Un expediente representa un proyecto licitado por la administración. Se identifica mediante un número de referencia único y contiene información crítica: fecha de presentación, importe base de licitación, descripción técnica y un \bft{pliego}. Este último detalla las actuaciones  a realizar y los requisitos  que la empresa debe cumplir para ser considerada apta.
\subsection{Adjudicación de licitación}
A la hora de buscar una licitación interesante, se debe mirar el pliego para ver que actuaciones tiene, como va de precio y la fecha de presentación. Si todo lo anterior cuadra con la empresa, significa que es una licitación apta para presentarte.
\subsubsection{Presentación}
Las empresas interesadas acuden a sesiones informativas para ver en detalle de que va el expediente. Tras esto se debe adjuntar una extensa documentación junto con los precios que ofrece la empresa para cada actuación del pliego. La empresa que mejores condiciones aporte sera la elegida.
